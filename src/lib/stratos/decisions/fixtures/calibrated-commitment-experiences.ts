...
import { MCDONALDS_IBM_AOT_2021_REVIEW_INPUT } from '../../scoring/mcdonalds-ibm-aot-2021-review';
import { MCDONALDS_IBM_AOT_2022_REVIEW_INPUT } from '../../scoring/mcdonalds-ibm-aot-2022-review';
import { MCDONALDS_IBM_AOT_2024_REVIEW_INPUT } from '../../scoring/mcdonalds-ibm-aot-2024-review';
...
export const CALIBRATED_COMMITMENT_EXPERIENCES = [
  ...
  buildExperience({
    profile: MCDONALDS_IBM_AOT,
    commitmentReview: MCDONALDS_IBM_AOT_2021_REVIEW_INPUT,
    snapshotId: 'capability-transfer-2021-10-27',
    sequence: 'T0',
    id: 'mcdonalds-ibm-aot-t0-2021-10-27',
    decisionDate: '2021-10-27',
    reassessmentDate: '2022-06-23',
    actor: "McDonald's restaurant-operations and technology sponsors responsible for the IBM AOT transfer",
    current: { factRef: 'mcd-aot-pre-transfer-accuracy', label: 'Ten-restaurant pilot operating at roughly 85% order accuracy' },
    requested: { factRef: 'mcd-tech-labs-transfer', label: 'Transfer McD Tech Labs to IBM to develop and scale AOT' },
    cadence: { factRef: 'mcd-aot-scale-work', label: 'Extend AOT across markets, languages, dialects, and menu variations' },
    requestedScale: 'cross-market IBM AOT development and deployment path',
    timelineLabel: 'Capability transfer to IBM',
    headline: 'Handing a tested capability to a partner before the scale gate was placed',
    irreversibility: 'high',
    unknowns: ['Order-accuracy release threshold', 'Crew-intervention ceiling', 'Transferability to IBM-run delivery', 'Program funding envelope'],
    secondaryExposureLabels: [
      'IBM acquisition and development-contract exposure',
      'Transferred AOT models, data, and integration assets',
      'Language, dialect, and menu-variation backlog',
      'IBM engineering and restaurant support capacity',
      'Undisclosed AOT program funding exposure',
    ],
    hindsightFactRef: 'mcd-aot-low-80s-accuracy',
  }),
  buildExperience({
    profile: MCDONALDS_IBM_AOT,
    commitmentReview: MCDONALDS_IBM_AOT_2022_REVIEW_INPUT,
    snapshotId: 'accuracy-warning-2022-06-23',
    sequence: 'T1',
    id: 'mcdonalds-ibm-aot-t1-2022-06-23',
    decisionDate: '2022-06-23',
    reassessmentDate: '2023-06-23',
    actor: "McDonald's restaurant-operations and technology sponsors responsible for the field test",
    current: { factRef: 'mcd-aot-low-80s-accuracy', label: 'AOT field accuracy reported in the low-80% range' },
    requested: { factRef: 'mcd-aot-test-24-restaurants', label: 'Continue the bounded field test across 24 Illinois restaurants' },
    cadence: { factRef: 'mcd-aot-95-percent-gate', label: 'Hold broader adoption behind a 95%-plus accuracy gate' },
    requestedScale: '24-restaurant bounded field test',
    timelineLabel: 'Field-accuracy warning',
    headline: 'The first public field measure lands below the adoption gate',
    irreversibility: 'medium',
    unknowns: ['Accuracy-improvement cycle', 'Crew-intervention load', 'Operational savings and speed results', 'Program spend and loss tolerance'],
    secondaryExposureLabels: [
      'Continuing IBM development and test exposure',
      'AOT deployment capital across the field test',
      'Unresolved language, dialect, and menu backlog',
      'Crew intervention and field-support capacity',
      'Undisclosed test and development spend',
    ],
    hindsightFactRef: 'mcd-aot-partnership-ended',
  }),
  buildExperience({
    profile: MCDONALDS_IBM_AOT,
    commitmentReview: MCDONALDS_IBM_AOT_2024_REVIEW_INPUT,
    snapshotId: 'ibm-path-halt-2024-06-17',
    sequence: 'T2',
    id: 'mcdonalds-ibm-aot-t2-2024-06-17',
    decisionDate: '2024-06-17',
    reassessmentDate: '2024-12-31',
    actor: "McDonald's chief restaurant officer and sponsors responsible for the IBM AOT path",
    current: { factRef: 'mcd-aot-over-100-restaurants', label: 'IBM AOT operating in more than 100 test restaurants' },
    requested: { factRef: 'mcd-aot-partnership-ended', label: 'End the IBM AOT partnership and explore other voice-ordering paths' },
    cadence: { factRef: 'mcd-aot-shutoff-by-july', label: 'Shut off AOT in every test restaurant by July 26' },
    requestedScale: 'no further IBM AOT deployment',
    timelineLabel: 'IBM AOT path halt',
    headline: 'The transferred capability reaches its wider-adoption floor',
    irreversibility: 'medium',
    unknowns: ['Terminal AOT accuracy', 'Realized operational savings', 'IBM AOT program spend', 'Successor-solution release criteria'],
    secondaryExposureLabels: [
      'IBM wind-down and successor-vendor exposure',
      'AOT assets deployed across more than 100 restaurants',
      'Remaining language, dialect, and menu backlog',
      'Restaurant shutoff and support capacity',
      'Undisclosed IBM AOT program spend',
    ],
  }),
] as const;
